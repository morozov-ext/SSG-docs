...
| 1. Вот пункт один<br>2. Вот пункт два<br>&nbsp;&nbsp;&nbsp;&nbsp;\!\[Выхухоль]{{(images/vih.png)}}<br>3. Вот пункт три  | <ol><li>Вот пункт один<li>Вот пункт два</li><img src="/images/vih.png" width="128"><li>Вот пункт три |
